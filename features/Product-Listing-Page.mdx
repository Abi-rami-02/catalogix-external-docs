...
<Accordion title="How to apply filter in a store">
  <Steps>
  <Step title="Filter button and attribute selection">
    Click on the filter button and select the attribute with which you want to filter the products.
...
![https://assets.catalogix.ai/2773e919626334732931a32723d37bd9](https://assets.catalogix.ai/2773e919626334732931a32723d37bd9)
  ...
  <Step title="Second Step">
    Select the required value for filtering and products will be filtered by that value.
...
<Accordion title="How to perform group edit">
  <Steps>
  <Step title="Select the products">
    Select the products that you want to edit to together.

    ![https://assets.catalogix.ai/63f6f4c35dd0ab4369d91d4845d3472a](https://assets.catalogix.ai/63f6f4c35dd0ab4369d91d4845d3472a)
  </Step>
  <Step title="Group edit toggle">
    Click on the group edit toggle.

![https://assets.catalogix.ai/981ecac84bcc7f8e36ebc67afc7cb7e2](https://assets.catalogix.ai/981ecac84bcc7f8e36ebc67afc7cb7e2)
  </Step>
  <Step title="Perform Edit">
    Now edit the attribute that you want to edit in bulk with same value. You can perform bulk edits on all selected the products by editing any one of the selected products.    
