## Overview
The PDP or Product Details Page has list of the sections that lets us delve deeper into the details of individual products.This section discusses the parts of PDP(Product Details Page).
